...
#'   geese_data_day1,
#'   simmr_loadcov(
#'     formula = mixtures ~ c(1,0,1,0,1,1,1,0,0),
  ...
  function(object, type = c("diagnostics", "quantiles", "statistics", "correlations"), group = 1, ...) {
    if (inherits(object, "simmr_output") == TRUE) {
        ...
        for (i in 1:length(group)) {
          ...
          #Cant make a matrix?? Unless we put the array into a matrix? 
          #Like have K cols for individual 1, K for individual 2, etc etc
